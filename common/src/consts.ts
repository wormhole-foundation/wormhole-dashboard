...
export const INITIAL_DEPLOYMENT_BLOCK_BY_NETWORK_AND_CHAIN: NetworkChainBlockMapping = {
  ['Mainnet']: {
    ...
    Hydration: '13154879', // https://hydration.subscan.io/tx/0xe507c930ebc33583efae04ab7d439806c226a2e02a43d7b3e7fbdcc7fc3c6946
  ...
  ['Testnet']: {
    ...
    MonadTestnet: '5776870', // Block of contract creation
