...
require (
	...
	github.com/certusone/wormhole/node v0.0.0-20221110135008-bc1a740cfaa8
...
require (
	...
	github.com/wormhole-foundation/wormhole/sdk v0.0.0-00010101000000-000000000000 // indirect
