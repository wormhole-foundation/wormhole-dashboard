...
require (
	...
	github.com/grafana/loki v1.6.2-0.20230721141808-0d81144cfee8 // indirect
	...
	github.com/wormhole-foundation/wormchain v0.0.0-00010101000000-000000000000 // indirect
